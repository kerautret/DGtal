...
/**
 * @file DrawWithGLUPViewer3DModifier.h
 * @author Aline Martin
 *
 * @date 2013/07/02
 *
 * Header file for module DrawWithGLUPViewer3DModifier.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(DrawWithGLUPViewer3DModifier_RECURSES)
#error Recursive header files inclusion detected in DrawWithGLUPViewer3DModifier.h
#else // defined(DrawWithGLUPViewer3DModifier_RECURSES)
/** Prevents recursive inclusion of headers. */
#define DrawWithGLUPViewer3DModifier_RECURSES

#if !defined DrawWithGLUPViewer3DModifier_h
/** Prevents repeated inclusion of headers. */
#define DrawWithGLUPViewer3DModifier_h
...
namespace DGtal
{
   ...
   *
   */
  struct DrawWithGLUPViewer3DModifier : public DrawWithDisplay3DModifier
  {
   ...
   */
  struct CameraPosition : public DrawWithGLUPViewer3DModifier
  {
    /**
     * Constructor.
     *
   ...
   */
  struct CameraDirection : public DrawWithGLUPViewer3DModifier
  {
    /**
     * Constructor.
     *
   ...
   */
  struct CameraUpVector : public DrawWithGLUPViewer3DModifier
  {
    /**
     * Constructor.
     *
   ...
   */
  struct CameraZNearFar : public DrawWithGLUPViewer3DModifier
  {
    /**
     * Constructor.
     *
  ...
  struct UpdateImage3DEmbedding : public DrawWithGLUPViewer3DModifier
  {
   ...
   */
  template < typename Space, typename KSpace>
  struct UpdateImagePosition : public DrawWithGLUPViewer3DModifier
  {
     ...
     *
     */
    UpdateImagePosition(unsigned int anIndex,typename GLUPViewer3D<Space,KSpace>::ImageDirection newDir,
    ...
    typename GLUPViewer3D<Space,KSpace>::ImageDirection myNewDirection;
  };
  ...
  struct AddTextureImage2DWithFunctor : public DrawWithGLUPViewer3DModifier
  {
    BOOST_CONCEPT_ASSERT((  concepts::CConstImage<TImageType> )) ;
    typedef typename GLUPViewer3D<Space,KSpace>::TextureMode TTextureMode;
   ...
   */
  template <typename TImageType, typename TFunctor, typename Space, typename KSpace>
  struct AddTextureImage3DWithFunctor : public DrawWithGLUPViewer3DModifier
  {
    BOOST_CONCEPT_ASSERT((  concepts::CConstImage<TImageType> )) ;
    typedef typename GLUPViewer3D<Space,KSpace>::TextureMode TTextureMode;
    /**
   ...
   */
  template < typename Space, typename KSpace>
  struct UpdateLastImagePosition : public DrawWithGLUPViewer3DModifier
  {
     ...
     *
     */
    UpdateLastImagePosition( typename GLUPViewer3D<Space, KSpace>::ImageDirection newDir,
  ...
  struct UpdateImageData : public DrawWithGLUPViewer3DModifier
  {
    ...
    UpdateImageData(unsigned int anIndex, ConstAlias<TImageType> anImage, double translateX=0,
		    ...
		    double rotationAngle=0.0, typename GLUPViewer3D<>::ImageDirection dirRotation=GLUPViewer3D<>::zDirection,
    ...
    typename GLUPViewer3D<>::ImageDirection  myRotationDir;
   };
   ...
   *
   */
  struct Translate2DDomain : public DrawWithGLUPViewer3DModifier
  {
   ...
   */
  template < typename Space, typename KSpace>
  struct Update2DDomainPosition : public DrawWithGLUPViewer3DModifier
  {
     ...
     *
     */
    Update2DDomainPosition(unsigned int anIndex, typename GLUPViewer3D<Space,KSpace>::ImageDirection newDir,
                           double posXbottomLeft, double posYbottomLeft, double posZbottomLeft ):  myIndex(anIndex),
                                                                                                   myPosXBottomLeft(posXbottomLeft),
                                                                                                   myPosYBottomLeft(posYbottomLeft),
                                                                                                   myPosZBottomLeft(posZbottomLeft),
...
#endif // !defined DrawWithGLUPViewer3DModifier_h

#undef DrawWithGLUPViewer3DModifier_RECURSES
#endif // else defined(DrawWithGLUPViewer3DModifier_RECURSES)
